...
(2, 'index.php', 2, '2019-04-02 21:01:38');
...
(8, '036208', 'PAID', '2019-04-01'),
(9, '036209', 'PAID', '2019-04-01'),
(10, '0362010', 'PAID', '2019-04-01'),
...
(11, '2019-04-02 12:08:45', '036208', 'Balatbat, Vince Martin', NULL, NULL, 'ID,Transcript of Records Fee,', '380.00', NULL, '380.00'),
(12, '2019-04-02 20:15:59', '036209', 'Kuriyama, Mirai', NULL, NULL, 'PE Uniform,Medical Exam,', '700.00', NULL, '700.00'),
(13, '2019-04-02 20:22:26', '0362010', 'Magtibay, Joshua Miguel', NULL, NULL, 'Graduate Forum,Publication,', '810.00', NULL, '810.00');
...
(17, '036208', '2019-04-02', 3, 3, '60.00', 'Active', '2019-04-02 12:08:45'),
(18, '036208', '2019-04-02', 3, 48, '320.00', 'Active', '2019-04-02 12:08:45'),
(19, '036209', '2019-04-02', 4, 68, '600.00', 'Active', '2019-04-02 20:15:59'),
(20, '036209', '2019-04-02', 4, 67, '100.00', 'Active', '2019-04-02 20:15:59'),
(21, '0362010', '2019-04-02', 3, 8, '570.00', 'Active', '2019-04-02 20:22:26'),
(22, '0362010', '2019-04-02', 3, 9, '240.00', 'Active', '2019-04-02 20:22:26');
...
(8, '2019-04-02', '036208', 'Individual', 'Balatbat, Vince Martin', '380.00', '0.00', '0.00', '0.00', '380.00', 'Active', '2019-04-02 00:00:00'),
(9, '2019-04-02', '036209', 'Individual', 'Kuriyama, Mirai', '700.00', '0.00', '0.00', '0.00', '700.00', 'Active', '2019-04-02 20:15:59'),
(10, '2019-04-02', '0362010', 'Individual', 'Magtibay, Joshua Miguel', '810.00', '0.00', '0.00', '0.00', '810.00', 'Active', '2019-04-02 00:00:00');
...
(4, '0682102047', '2019-004', '1890.00', 'PENDING', '2019-04-02', NULL);
...
--
ALTER TABLE `f_lock_screen_log`
  MODIFY `ls_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `t_cash_receipt_record`
  MODIFY `crt_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `t_cr_register_income_references`
--
ALTER TABLE `t_cr_register_income_references`
  MODIFY `cr_ir_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
